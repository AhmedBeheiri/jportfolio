...
--
-- Class ContactMessage as table contact_message
--
...
CREATE TABLE "projects" (
    ...
    "secondaryActionIcon" text,
    "workedAt" json
);

--
-- Class SocialLink as table social_links
--
...
--
-- Class TechStack as table tech_stacks
--
...
--
-- Class WorkExperience as table work_experience
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('backend', '20251226194050284', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251226194050284', "timestamp" = now();
